...
def state_to_convexhull(state):
    # convert Kalman state vector into a convex hull
    # convert state to a array that we can directly pass to min_max_y function
    # https://github.com/zifanw/ConvexHull2D/blob/master/Demo.ipynb
    model = ConvexHull2D()
    points = []
